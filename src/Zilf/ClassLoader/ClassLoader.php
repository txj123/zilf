 ...
 *     $loader->addPrefix('Zilf', __DIR__.'/component');
 ...
 *
 * In this example, if you try to use a class in the Zilf
 * namespace or one of its children (Zilf\Console for instance),
