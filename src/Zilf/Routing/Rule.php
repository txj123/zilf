...
use think\Container;
use Zilf\Routing\Dispatch\Callback as CallbackDispatch;
use think\route\dispatch\Controller as ControllerDispatch;
use Zilf\Routing\Dispatch\Module as ModuleDispatch;
...
abstract class Rule
{
    ...
    abstract public function check($url, $completeMatch = false);
     ...
     * @return Dispatch
     */
    public function parseRule($rule, $route, $url, $option = [], $matches = [])
    {
     ...
     * @return Dispatch
     */
    protected function dispatch($route, $option)
    {
