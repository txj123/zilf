...
namespace Zilf\Debug\Tests;

use Zilf\Debug\DebugClassLoader;
use Zilf\Debug\ErrorHandler;
...
class DebugClassLoaderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testIdempotence()
    {
        ...
        foreach ($functions as $function) {
            if (is_array($function) && $function[0] instanceof DebugClassLoader) {
                ...
                $this->assertNotInstanceOf('Zilf\Debug\DebugClassLoader', $reflProp->getValue($function[0]));
    ...
    public function testStacking()
    {
        ...
        if (class_exists('Zilf\Debug\Exception\ContextErrorException', false)) {
    ...
    public function testDeprecatedSuper($class, $super, $type)
    {
        ...
        $xError = array(
            ...
            'message' => 'The Test\Zilf\Debug\Tests\\'.$class.' class '.$type.' Zilf\Debug\Tests\Fixtures\\'.$super.' that is deprecated but this is a test deprecation notice.',
        );
    ...
    public function testDeprecatedSuperInSameNamespace()
    {
        ...
        class_exists('Zilf\Bridge\Debug\Tests\Fixtures\ExtendsDeprecatedParent', true);
    ...
    public function testReservedForPhp7()
    {
        ...
        $xError = array(
            'type' => E_USER_DEPRECATED,
            'message' => 'Test\Zilf\Debug\Tests\Float uses a reserved class name (Float) that will break on PHP 7 and higher',
        );
...
class ClassLoader
{
    ...
    public function findFile($class)
    {
        ...
        } elseif ('Zilf\Bridge\Debug\Tests\Fixtures\ExtendsDeprecatedParent' === $class) {
            eval('namespace Zilf\Bridge\Debug\Tests\Fixtures; class ExtendsDeprecatedParent extends \\'.__NAMESPACE__.'\Fixtures\DeprecatedClass {}');
