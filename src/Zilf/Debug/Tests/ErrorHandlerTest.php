...
use Zilf\Debug\BufferingLogger;
...
class ErrorHandlerTest extends \PHPUnit_Framework_TestCase
{
    public function testRegister()
    {
        ...
        try {
            $this->assertInstanceOf('Zilf\Debug\ErrorHandler', $handler);
    ...
    public function testNotice()
    {
        ...
        try {
            ...
            $this->assertEquals('Zilf\Debug\ErrorHandler', $trace[0]['class']);
    ...
    public function testHandleErrorException()
    {
        ...
        $this->assertInstanceOf('Zilf\Debug\Exception\ClassNotFoundException', $args[0]);
