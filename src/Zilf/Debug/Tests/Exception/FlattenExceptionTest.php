...
namespace Zilf\Debug\Tests\Exception;

use Zilf\Debug\Exception\FlattenException;
use Zilf\HttpKernel\Exception\NotFoundHttpException;
use Zilf\HttpKernel\Exception\MethodNotAllowedHttpException;
use Zilf\HttpKernel\Exception\UnauthorizedHttpException;
use Zilf\HttpKernel\Exception\BadRequestHttpException;
use Zilf\HttpKernel\Exception\NotAcceptableHttpException;
use Zilf\HttpKernel\Exception\ConflictHttpException;
use Zilf\HttpKernel\Exception\AccessDeniedHttpException;
use Zilf\HttpKernel\Exception\GoneHttpException;
use Zilf\HttpKernel\Exception\LengthRequiredHttpException;
use Zilf\HttpKernel\Exception\PreconditionFailedHttpException;
use Zilf\HttpKernel\Exception\PreconditionRequiredHttpException;
use Zilf\HttpKernel\Exception\ServiceUnavailableHttpException;
use Zilf\HttpKernel\Exception\TooManyRequestsHttpException;
use Zilf\HttpKernel\Exception\UnsupportedMediaTypeHttpException;
...
class FlattenExceptionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testPreviousError()
    {
        ...
        $this->assertEquals($flattened->getClass(), 'Zilf\Debug\Exception\FatalThrowableError', 'The class is set to the class of the original exception');
    }
