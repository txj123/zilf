 ...
 *
 * Migration is designed to be used together with the "Zilf migrate" command.
 *
 ...
 * logic. The "Zilf migrate" command manages all available migrations in an application.
 *
