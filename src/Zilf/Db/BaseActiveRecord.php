...
use Zilf\Db\base\Model;
use Zilf\Db\base\ModelEvent;
use Zilf\Db\base\NotSupportedException;
use Zilf\Db\base\UnknownMethodException;
...
abstract class BaseActiveRecord extends Model implements ActiveRecordInterface
{
     ...
     *    Or add [[\Zilf\behaviors\OptimisticLockBehavior|OptimisticLockBehavior]] to your model 
     ...
     *                                 [[\Zilf\behaviors\AttributeTypecastBehavior]] to facilitate attribute typecasting.
     *                                 See http://www.Zilfframework.com/doc-2.0/guide-db-active-record.html#attributes-typecasting.
     */
    ...
    public function link($name, $model, $extraColumns = [])
    {
        ...
        if ($relation->via !== null) {
            ...
            if (is_array($relation->via)) {
                ...
                $record = Zilf::createObject($viaClass);
     ...
     * @param string $name   the case sensitive name of the relationship, e.g. `orders` for a relation defined via `getOrders()` method.
     * @param bool   $delete whether to delete the model that contains the foreign key.
     *                       Note that the deletion will be performed using
     *                       [[deleteAll()]], which will not trigger any events on the
     *                       related models. If you need [[EVENT_BEFORE_DELETE]] or
     *                       [[EVENT_AFTER_DELETE]] to be triggered, you need to
     *                       [[find()|find]] the models first and then call
