...
use Zilf\Db\base\StaticInstanceInterface;
...
interface ActiveRecordInterface extends StaticInstanceInterface
{
     ...
     *
     * ```php
     * // Zilf\web\Controller ensures that $id is scalar
     ...
     * ```
     *
     * @param  bool  $runValidation  whether to perform validation (calling [[\Zilf\Db\base\Model::validate()|validate()]])
     *                               before saving the record. Defaults to `true`. If the validation fails, the record will
     *                               not be saved to the database and this method will return `false`.
