...
use Zilf\Helpers\VarDumper;
use Zilf\web\HttpException;

/**
 * ErrorHandler handles uncaught PHP errors and exceptions.
 *
 * ErrorHandler is configured as an application component in [[\Zilf\Db\base\Application]] by default.
 * You can access that instance via `Zilf::$app->errorHandler`.
 *
    ...
    protected function handleFallbackExceptionMessage($exception, $previousException)
    {
        ...
        if (Zilf::$app->is_debug) {
            if (PHP_SAPI === 'cli') {
                ...
                echo '<pre>' . htmlspecialchars($msg, ENT_QUOTES, Zilf::$app->charset) . '</pre>';
            }
        } else {
