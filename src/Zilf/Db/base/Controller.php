 ...
 * read-only.
 * @property View|\Zilf\web\View $view The view object that can be used to render views or view files.
...
class Controller extends Component implements ViewContextInterface
{
     ...
     * ```
     *
     * [[\Zilf::createObject()]] will be used later to create the requested action
    ...
    public function run($route, $params = [])
    {
        ...
        return Zilf::$app->runAction(ltrim($route, '/'), $params);
    }
    ...
    public function createAction($id)
    {
        ...
        if (isset($actionMap[$id])) {
            return Zilf::createObject($actionMap[$id], [$id, $this]);
