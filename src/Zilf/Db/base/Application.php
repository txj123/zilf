 ...
 *
 * @property \Zilf\web\AssetManager $assetManager The asset manager application component. This property is
 * read-only.
 * @property \Zilf\rbac\ManagerInterface $authManager The auth manager application component. Null is returned
 * if auth manager is not configured. This property is read-only.
 * @property string $basePath The root directory of the application.
 * @property \Zilf\caching\CacheInterface $cache The cache application component. Null if the component is not
 ...
 * @property \Zilf\Db\Connection $db The database connection. This property is read-only.
 * @property \Zilf\web\ErrorHandler|\Zilf\console\ErrorHandler $errorHandler The error handler application
 * component. This property is read-only.
 * @property \Zilf\i18n\Formatter $formatter The formatter application component. This property is read-only.
 * @property \Zilf\i18n\I18N $i18n The internationalization application component. This property is read-only.
 * @property \Zilf\log\Dispatcher $log The log dispatcher application component. This property is read-only.
 * @property \Zilf\mail\MailerInterface $mailer The mailer application component. This property is read-only.
 * @property \Zilf\web\Request|\Zilf\console\Request $request The request component. This property is read-only.
 * @property \Zilf\web\Response|\Zilf\console\Response $response The response component. This property is
 * read-only.
 * @property string $runtimePath The directory that stores runtime files. Defaults to the "runtime"
 * subdirectory under [[basePath]].
 * @property \Zilf\Db\base\Security $security The security application component. This property is read-only.
 * @property string $timeZone The time zone used by this application.
 * @property string $uniqueId The unique ID of the module. This property is read-only.
 * @property \Zilf\web\UrlManager $urlManager The URL manager for this application. This property is read-only.
 * @property string $vendorPath The directory that stores vendor files. Defaults to "vendor" directory under
 * [[basePath]].
 * @property View|\Zilf\web\View $view The view application component that is used to render various view
...
abstract class Application extends Module
{
    ...
    /**
     * @var array list of installed Zilf extensions. Each array element represents a single extension
    ...
    public function setBasePath($path)
    {
        ...
        Zilf::setAlias('@app', $this->getBasePath());
    }
    ...
    {
        return [
            'log' => ['class' => 'Zilf\log\Dispatcher'],
            'view' => ['class' => 'Zilf\web\View'],
            'formatter' => ['class' => 'Zilf\i18n\Formatter'],
            'i18n' => ['class' => 'Zilf\i18n\I18N'],
            'mailer' => ['class' => 'Zilf\swiftmailer\Mailer'],
            'urlManager' => ['class' => 'Zilf\web\UrlManager'],
            'assetManager' => ['class' => 'Zilf\web\AssetManager'],
            'security' => ['class' => 'Zilf\Db\base\Security'],
        ];
    }
    ...
    /**
     * Configures [[Zilf::$container]] with the $config.
     *
    ...
    {
        Zilf::configure(Zilf::$container, $config);
    }
}
