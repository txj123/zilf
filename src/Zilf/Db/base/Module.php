...
class Module extends ServiceLocator
{
    ...
    {
        return Zilf::getAlias('@' . str_replace('\\', '/', $this->controllerNamespace));
    }
    ...
    {
        $this->_viewPath = Zilf::getAlias($path);
    }
    ...
    {
        $this->_layoutPath = Zilf::getAlias($path);
    }
     ...
     * array that can be used to create the module. In the latter case, [[Zilf::createObject()]]
    ...
    public function runAction($route, $params = [])
    {
        ...
        if (is_array($parts)) {
            ...
            $oldController = Zilf::$app->controller;
            Zilf::$app->controller = $controller;
            $result = $controller->runAction($actionID, $params);
            if ($oldController !== null) {
                Zilf::$app->controller = $oldController;
            }
    ...
    public function createController($route)
    {
        ...
        if (isset($this->controllerMap[$id])) {
            $controller = Zilf::createObject($this->controllerMap[$id], [$id, $this]);
