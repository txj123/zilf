...
trait ArrayableTrait
{
    ...
    {
        $fields = array_keys(Zilf::getObjectVars($this));
     ...
     *                          If empty or if it contains
     *                          '*', all fields as
     *                          specified by [[fields()]]
     *                          will be returned. Fields
     *                          can be nested, separated
     *                          with dots (.). e.g.:
     *                          item.field.sub-field
     *                          `$recursive` must be true
     *                          for nested fields to be
     *                          extracted. If `$recursive`
     *                          is false, only the root
     *                          fields will be extracted.
     * @param  array $expand    the additional fields being requested for exporting. Only fields declared in [[extraFields()]]
     *                          will be considered. Expand can also be nested, separated with dots (.). e.g.:
     *                          item.expand1.expand2 `$recursive` must be true for nested expands to be extracted. If
