 ...
 * its parent class [[\Zilf\Db\base\BaseObject|BaseObject]].
 *
 ...
 * ```
 *
 * where `as tree` stands for attaching a behavior named `tree`, and the array will be passed to [[\Zilf::createObject()]]
...
class Component extends BaseObject
{
     ...
     *     Zilf::trace($event->name . ' is triggered.');
     * });
     * ```
     *
     * @param string $name the event name
     ...
     *  - an object configuration array that will be passed to [[Zilf::createObject()]] to create the behavior object.
     *
