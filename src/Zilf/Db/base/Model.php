 ...
 *
 * @property \Zilf\validators\Validator[] $activeValidators The validators applicable to the current
 ...
 * @property ArrayObject|\Zilf\validators\Validator[] $validators All the validators declared in the model.
...
class Model extends Component implements StaticInstanceInterface, IteratorAggregate, ArrayAccess, Arrayable
{
     ...
     *
     * Zilf also provides a set of [[Validator::builtInValidators|built-in validators]].
     ...
     *
     * The form name is mainly used by [[\Zilf\widgets\ActiveForm]] to determine how to name
     ...
     * ```
     *
     * @return ArrayObject|\Zilf\validators\Validator[] all the validators declared in the model.
     */
     ...
     * @return \Zilf\validators\Validator[] the validators applicable to the current [[scenario]].
     */
     ...
     * [[\Zilf\validators\RequiredValidator|required]] validation rule in the
     * current [[scenario]].
     *
     * Note that when the validator has a conditional validation applied using
     * [[\Zilf\validators\RequiredValidator::$when|$when]] this method will return
     ...
     *                        A safe attribute is one that is associated with a validation rule
